...
class U3PMaxVitEncoder(nn.Module):
    def __init__(self, backbone='maxvit_base_tf_512', pretrained=False):
        super().__init__()
...
class UNet3Plus(nn.Module):
    ...
    def __init__(self,
        ...
        self.encoder = U3PMaxVitEncoder(channels) if encoder is None else encoder
